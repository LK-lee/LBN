        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white mb-0">Edit Referrals</h6>
                ...
                <div class="col-lg-6 col-5 text-right d-none">
                    ...
                    <a href="Edit_Joins.php" class="btn bg-warning text-white">Edit Referral</a>
                </div>
...
<h3 id="pageTitle">Edit Referral</h3>
</div>
...
<i class="fas fa-save"></i>&ensp;Update Referral
</button>
</div>
